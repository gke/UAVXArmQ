...
Connect your multicopter as you would for the GCS but do NOT launch the GCS. Instead launch the BLHeliSuite application.
...
If you are not programming ESCs and just using the GCS do not connect until after the YELLOW LED is off otherwise UAVX will think the GCS is BLHeliSuite and hang!

https://blhelisuite.wordpress.com/

When you are finished hit the disconnect button and close BLHeliSuite. UAVX should then complete its initialisation and can be connected to the GCS if you wish.
