...
You should **not** use the Tx trims which should be set to NEUTRAL (no trims). Choose a day when there is no wind. You only need to do this once unless you have a major crash as there is very little in the accelerometer neutral values.
